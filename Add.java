...
class Add extends JFrame   
{
    ...
    Add()
    {
        ...
        lab = new JLabel("Add Student Details");
        lab.setFont(f3);
              ...
              txtrno.requestFocus();
                  ...
                  else 
                {
                    try
                    {
                        ...
                        pst.executeUpdate();
                        JOptionPane.showMessageDialog(c,"Details Record");
                        txtrno.setText("");
                        txtname.setText("");
                        txtmarks.setText("");
                        con.close();
                ...
                {
                    JOptionPane.showMessageDialog(c, "<html>Rollno/Name/Marks cannot be empty or Invalid Data</html>");
                    txtmarks.setText("");
                    txtrno.setText("");
                    txtrno.requestFocus();
                ...
                {
                    JOptionPane.showMessageDialog(c, "Invalid Data"+e);
                    txtmarks.setText("");
                    txtname.setText("");
                    txtrno.setText("");
                    txtrno.requestFocus();
